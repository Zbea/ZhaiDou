...
public class Constant extends EaseConstant{
	...
	public static final String DEFAULT_COSTOMER_APPKEY = "zhaidou#zhaidou";
	public static final String DEFAULT_COSTOMER_ACCOUNT = "service";
	public static final String DEFAULT_ACCOUNT_PWD = "123456";

	public static final int MESSAGE_TO_DEFAULT = 0;
	public static final int MESSAGE_TO_DESIGNER = 1;
