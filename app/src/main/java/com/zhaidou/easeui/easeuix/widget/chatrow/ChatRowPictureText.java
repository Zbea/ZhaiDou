...
import com.zhaidou.easeui.helpdesk.domain.OrderMessageEntity;
import com.zhaidou.easeui.helpdesk.domain.TrackMessageEntity;
import com.zhaidou.easeui.helpdesk.ui.ChatFragment;
import com.zhaidou.easeui.helpdesk.ui.ContextMenuActivity;
...
public class ChatRowPictureText extends EaseChatRow {
	...
	protected void onInflatView() {
		if (EaseHelper.getInstance().isPictureTxtMessage(message)) {
