...
//            mPage = getArguments().getString(PAGE);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View mView=inflater.inflate(R.layout.fragment_goods_detail_info, container, false);
    ...
    public void FetchDetailData(){
        JsonObjectRequest request=new JsonObjectRequest("http://192.168.199.173/special_mall/api/merchandises/6",new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject jsonObject) {
                if (jsonObject!=null){
                    JSONArray descriptions=jsonObject.optJSONObject("merchandise").optJSONArray("descriptions");
