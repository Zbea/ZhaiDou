package com.zhaidou.view.stretch;
...
public class PicGallery extends Gallery
{
    ...
    private StretchImageView imageView;
    ...
    public PicGallery(Context context, AttributeSet attrs)
    {
        ...
        this.setOnTouchListener(new OnTouchListener()
        {
            ...
            public boolean onTouch(View v, MotionEvent event)
            {
                ...
                {
                    imageView = (StretchImageView) view;
                            ...
                            float distanceY)
    {
        ...
        if (view instanceof StretchImageView)
        {
            ...
            Log.d("zhaidou", "xdistance=" + xdistance + ",min_distance="
                    + min_distance);
            ...
            } else
            {
                ...
                if (distanceX > 0)// 向左滑动
                {
                    if (r.left > 0 || right < MainActivity.screenWidth)
                    {// 判断当前ImageView是否显示完全
                        super.onScroll(e1, e2, distanceX, distanceY);
                    } else
                    {
